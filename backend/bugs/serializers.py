...
class BugReportSerializer(serializers.ModelSerializer):
    ...
    def to_internal_value(self, data):
        ...
        if new_status:
            for status_key in ['status', 'dev_status', 'devStatus', 'testerStatus']:
                data[status_key] = new_status
    ...
    def get_assignedOn(self, obj):
        if not obj.assigned_on:
            return ''
        return obj.assigned_on.strftime('%d %B %Y').lstrip('0')
...
class ProjectSubmissionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'developer_id', 'developerId', 'subject', 'project_link', 'projectLink',
