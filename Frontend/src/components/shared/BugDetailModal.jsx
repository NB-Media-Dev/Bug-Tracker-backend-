      ...
      <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[85vh] overflow-y-auto flex flex-col border border-gray-200">
        ...
        <div className="p-6 space-y-4 text-xs">
          ...
          <div>
            ...
            <div className="text-gray-700 mt-1 bg-gray-50 p-2.5 rounded border border-gray-200 max-h-48 overflow-y-auto break-words break-all">
              {steps.length === 0 ? (
                ...
                <ul className="list-disc pl-5 space-y-1 text-gray-800 font-medium">
                  {steps.map((line) => (
                    <li key={line} className="break-words break-all">{line}</li>
                  ))}
                </ul>
              )}
            </div>
