...
function DesignerMyReport({ designer, developer: propDev }) {
  const developer = designer || propDev;
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[85vh] overflow-y-auto flex flex-col border border-gray-200">
            ...
            <div className="p-6 space-y-4 text-xs">
              ...
              <div>
                ...
                <div className="text-gray-700 mt-1 bg-gray-50 p-2.5 rounded border border-gray-200 max-h-44 overflow-y-auto break-words break-all">
                  {(() => {
                    ...
                    return (
                      <ol className="list-decimal pl-5 space-y-1.5 text-gray-800 font-medium">
                        {lines.map((line, idx) => {
                          ...
                          return <li key={`step-${idx}`} className="break-words break-all">{cleaned}</li>;
                        })}
                      </ol>
                    );
                  })()}
...
export default DesignerMyReport;
