...
//             <Shield size={12} /> QA Workspace Active
//           </div>
...
//           <div className="space-y-1">
//             <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Active Projects</span>
//             <div className="text-2xl font-extrabold text-gray-900">{activeProjects}</div>
//           </div>
...
//         <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-2xs flex items-center justify-between">
//           <div className="space-y-1">
//             <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Bugs Logged</span>
//             <div className="text-2xl font-extrabold text-gray-900">{totalLogged}</div>
//           </div>
...
//         <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-2xs flex items-center justify-between">
//           <div className="space-y-1">
//             <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Pending Re-Test</span>
...
//         <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-2xs flex items-center justify-between">
//           <div className="space-y-1">
//             <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Bugs Resolved</span>
//             <div className="text-2xl font-extrabold text-gray-900">{resolvedCount}</div>
//           </div>
...
//           <button
//             onClick={() => onNavigate("/tester/reportfrom")}
//             className="flex items-center justify-center gap-2 p-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold text-xs rounded-xl shadow-2xs transition-all cursor-pointer hover:scale-[1.01]"
//           >
//             <Plus size={14} /> Report New Bug
//           </button>
//           <button
//             onClick={() => onNavigate("/tester/bugreport")}
//             className="flex items-center justify-center gap-2 p-3 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 font-semibold text-xs rounded-xl shadow-2xs transition-all cursor-pointer hover:scale-[1.01]"
//           >
//             <FileText size={14} /> My Bug Reports
//           </button>
//           <button
//             onClick={() => onNavigate("/tester/help")}
//             className="flex items-center justify-center gap-2 p-3 bg-gray-50 hover:bg-gray-100 text-gray-700 font-semibold text-xs rounded-xl shadow-2xs transition-all cursor-pointer hover:scale-[1.01]"
//           >
//             <HelpCircle size={14} className="text-gray-400" /> Help & Support
//           </button>
//         </div>
//       </div>
...
//               </div>
//                 {newNotifications.length > 0 ? (
//                   newNotifications.map((build) => (
//                     <div
//                       key={build.id}
//                       className="p-2 bg-blue-50/40 rounded-xl border border-blue-100 flex flex-col gap-2 hover:bg-blue-50/80 transition-colors shadow-2xs"
//                     >
//                       <div className="flex items-center justify-between">
//                         <span className="font-extrabold text-[11px] text-gray-900 flex items-center gap-1.5 truncate">
//                           <FileArchive size={13} className="text-blue-600 shrink-0" />
//                           {build.projectName}
//                         </span>
...
//                   currentOldNotifications.map((build) => (
//                     <div key={build.id} className="p-2 bg-gray-50/50 rounded-xl border border-gray-200 flex flex-col gap-2 hover:bg-gray-50 transition-colors opacity-75 hover:opacity-100">
//                       <div className="flex items-center justify-between">
//                         <span className="font-extrabold text-[11px] text-gray-700 flex items-center gap-1.5 truncate">
//                           <FileArchive size={13} className="text-gray-400 shrink-0" />
//                           {build.projectName}
//                         </span>
//                         <span className="text-[9px] text-gray-450 font-mono shrink-0">{build.date || "Just now"}</span>
//                       </div>
...
//                       <div className="pt-1 flex items-center justify-end">
//                         <button onClick={() => handleStartTesting(build)} className="px-2 py-0.5 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs rounded shadow-2xs transition-all cursor-pointer">Start Testing</button>
//                       </div>
//                     </div>
//                   ))
//                 ) : (
...
//             <p className="text-xs text-gray-500">Quick links for tester tasks</p>
//           </div>
...
//             </button>
//             <button
//               onClick={() => onNavigate("/tester/inbox")}
//               className="text-gray-600 font-semibold hover:text-gray-700 cursor-pointer"
//             >
//               Inbox
//             </button>
//           </div>
...
//           <button
//             onClick={() => onNavigate("/tester/inbox")}
//             className="group flex items-center gap-4 p-4 rounded-2xl border border-indigo-100 bg-indigo-50/60 hover:bg-indigo-100/80 transition-all text-left cursor-pointer"
//           >
//             <div className="p-3 bg-indigo-100 text-indigo-600 rounded-xl shrink-0 group-hover:bg-indigo-600 group-hover:text-white transition-colors">
//               <Play size={20} />
//             </div>
//             <div>
//               <p className="text-xs uppercase text-indigo-700 font-bold">Start Testing</p>
//               <p className="text-xs text-gray-600 mt-0.5">Open inbox to begin testing builds.</p>
//             </div>
//           </button>

//           <button
//             onClick={() => onNavigate("/tester/bugreport")}
//             className="group flex items-center gap-4 p-4 rounded-2xl border border-emerald-100 bg-emerald-50/60 hover:bg-emerald-100/80 transition-all text-left cursor-pointer"
//           >
//             <div className="p-3 bg-emerald-100 text-emerald-600 rounded-xl shrink-0 group-hover:bg-emerald-600 group-hover:text-white transition-colors">
//               <FileCheck size={20} />
//             </div>
//             <div>
//               <p className="text-xs uppercase text-emerald-700 font-bold">My Reports</p>
//               <p className="text-xs text-gray-600 mt-0.5">View and manage reported bugs.</p>
//             </div>
//           </button>
...
//     {id:2,label: "Bugs Logged", value: totalLogged, icon: <Bug size={20} />, iconWrapper: "bg-indigo-50 text-indigo-600" },
...
//     {id:3, label: "Help & Support", icon: <HelpCircle size={14} className="text-gray-400" />, onClick: () => onNavigate("/tester/help"), className: "bg-gray-50 hover:bg-gray-100 text-gray-700" }
//   ];

//   const actionCenterCards = [
//     { id:1,title: "Start Testing", desc: "Open inbox to begin testing builds.", icon: <Play size={20} />, path: "/tester/inbox", border: "border-indigo-100 bg-indigo-50/60 hover:bg-indigo-100/80", iconBg: "bg-indigo-100 text-indigo-600 group-hover:bg-indigo-600 group-hover:text-white", titleColor: "text-indigo-700" },
//     { id:2,title: "My Reports", desc: "View and manage reported bugs.", icon: <FileCheck size={20} />, path: "/tester/bugreport", border: "border-emerald-100 bg-emerald-50/60 hover:bg-emerald-100/80", iconBg: "bg-emerald-100 text-emerald-600 group-hover:bg-emerald-600 group-hover:text-white", titleColor: "text-emerald-700" }
//   ];
...
//               className={`group flex items-center gap-4 p-4 rounded-2xl border transition-all text-left cursor-pointer ${card.border}`}
//             >
//               <div className={`p-3 rounded-xl shrink-0 transition-colors ${card.iconBg}`}>
//                 {card.icon}
//               </div>
//               <div>
//                 <p className={`text-xs uppercase font-bold ${card.titleColor}`}>{card.title}</p>
