...
function Reportform({ onNavigate }) {
  ...
  const handleSubmit = async (e) => {
    ...
    const { bugId: nextBugId, projectBugNumber: nextProjectBugNum } =
      getNextBugIdForProject(formData.module, submittedBugs, existingBugs);
            ...
            <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-xs space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 text-xs border rounded-lg transition-all text-gray-800 ${
                    isReopenMode
                ...
                {isProjectFixed ? (
                  ...
                  <div className="space-y-2">
                    {availableProjects.length > 0 && (
                      <select
                        value={
                          availableProjects.includes(formData.module)
                            ? formData.module
                            : formData.module
                              ? "__custom__"
                              : ""
                        ...
                        className="w-full text-xs border border-gray-300 rounded-lg p-2 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500/20 text-gray-800 font-semibold"
                      >
                    ...
                    {(!availableProjects.length ||
                      ...
                      <input
                        ...
                        value={formData.module}
                        onChange={handleInputChange}
                        placeholder="Enter Project Name (e.g. Banking App)"
                        className="w-full px-3 py-2 text-xs border border-gray-300 rounded-lg bg-gray-50/50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-gray-800 font-semibold"
                        required
                      />
                    )}
                  </div>
              ...
              <>
                <button
                  ...
                  onClick={async () => {
                    if (submittedBugs.length === 0) {
                      alert(
                        "Please add at least one bug report to the table before sending.",
                      );
                      return;
                    }
                      ...
                      try {
                        await fetch(`${API_BASE}/api/bugs/`, {
                          ...
                          body: JSON.stringify({
                            ...
                            tester_email:
                              b.testerEmail || "prasanna_tester@gmail.com",
                            developer_name:
                              b.developerName || b.develper || "Unassigned",
                    ...
                    alert(
                      "Report successfully saved to Database and sent to developers!",
                    );
                    setSubmittedBugs([]);
                    loadAllBugs();
                    if (onNavigate) {
