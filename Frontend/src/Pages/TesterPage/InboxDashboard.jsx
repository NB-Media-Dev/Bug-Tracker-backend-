            ...
            <div className="flex flex-col h-full">
              ...
              <div className="p-4 border-t border-gray-150 bg-gray-50/50 flex flex-wrap items-center justify-between gap-3">
                {(() => {
                  ...
                  const isClaimed = activeMessage.claimedBy || activeMessage.claimed_by || activeMessage.status === 'Testing';
                    ...
                    if (isClaimedByMe) {
                      return (
                        <>
                          ...
                          <button
                            onClick={() => {
                              localStorage.setItem("selected_project_name", activeMessage.projectName || activeMessage.project_name || "");
                              localStorage.setItem("selected_developer_name", activeMessage.developerName || activeMessage.developer_name || "");
                              localStorage.setItem("selected_developer_id", activeMessage.developerId || activeMessage.developer_id || "");
                          ...
                          >
                            <FileText size={14} /> Report Bug for this Build
                          </button>
                        </>
                      );
                    } else {
