...
//           .map(b => ({
//             id: b.id,
//             bugId: b.bugId || b.bug_id || `BUG-${b.id}`,
//             title: b.title,
...
//                   <AlertCircle className="text-red-650" size={24} />
//                 </div>
...
//                           <button
//                             key={bug.id}
//                             className="p-3 border border-gray-200 rounded-xl hover:border-blue-500 hover:shadow-2xs transition-all flex flex-col gap-1.5 cursor-pointer"
...
//           <div className="bg-white rounded-2xl shadow-xl border border-gray-250 max-w-xl w-full max-h-[85vh] overflow-y-auto flex flex-col">
